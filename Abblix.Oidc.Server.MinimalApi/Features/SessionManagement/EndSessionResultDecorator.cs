...
/// <summary>
/// Decorates <see cref="IEndSessionResultFormatter"/> to delete the session-management cookie when session management
/// is enabled, so the browser's logged-in state is cleared as part of logout.
/// </summary>
public class EndSessionResultDecorator(
    IEndSessionResultFormatter inner,
    ISessionManagementService sessionManagementService) : IEndSessionResultFormatter
{
    /// <inheritdoc />
