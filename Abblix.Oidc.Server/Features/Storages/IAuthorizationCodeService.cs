...
public interface IAuthorizationCodeService
{
    ...
    /// <returns>A task that asynchronously returns a <see cref="Result<AuthorizedGrant, RequestError>"/> representing the outcome
    /// of the authorization process, including any access tokens or refresh tokens issued as part of the grant.</returns>
    Task<Result<AuthorizedGrant, RequestError>> AuthorizeByCodeAsync(string authorizationCode);
