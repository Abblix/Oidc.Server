...
/// <summary>
/// Represents a validation error for a client request in the context of OpenID Connect.
/// </summary>
...
public record ClientRequestValidationError(string Error, string ErrorDescription)
