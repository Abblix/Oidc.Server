...
/// <summary>
/// Represents an error response in the user information request process.
/// </summary>
...
public record UserInfoErrorResponse(string Error, string ErrorDescription) : UserInfoResponse;
