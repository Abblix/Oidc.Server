...
// (as of .NET 10 it exposes only RFC 5649, Aes.EncryptKeyWrapPadded/DecryptKeyWrapPadded). The
// known-answer vectors in AesKeyWrapTests pin the construction byte-exact, so they survive the swap and
// prove the replacement — the tests assert the RFC vectors, not implementation details, precisely for this.
