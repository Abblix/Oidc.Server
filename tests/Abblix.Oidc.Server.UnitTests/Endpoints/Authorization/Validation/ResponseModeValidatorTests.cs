...
public class ResponseModeValidatorTests
{
    ...
    [InlineData(FlowTypes.None, ResponseModes.Query, true)]
    [InlineData(FlowTypes.None, ResponseModes.Fragment, true)]
    [InlineData(FlowTypes.None, ResponseModes.FormPost, true)]
