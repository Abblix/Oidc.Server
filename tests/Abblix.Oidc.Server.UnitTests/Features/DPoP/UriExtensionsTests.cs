...
/// used for DPoP <c>htu</c> comparison per RFC 9449 section 6 and RFC 3986 section 6.2: scheme and
...
public class UriExtensionsTests
{
    ...
    // Case normalisation per RFC 3986 section 6.2.2.1 - scheme and host folded to lowercase,
    // path case is significant and stays verbatim.
    [InlineData("HTTPS://Example.COM/Path", "https://example.com/Path")]

    // Default-port stripping per RFC 3986 section 6.2.3.
    ...
    // Query and fragment dropped (DPoP-specific, RFC 9449 section 4.3 / section 6).
    ...
    // Empty path becomes "/" per RFC 3986 section 6.2.3.
    ...
    // Percent-encoding case normalisation per RFC 3986 section 6.2.2.2: hex digits
