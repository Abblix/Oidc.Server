...
public class NoRegionsAnalyzerTests
{
    ...
    /// <summary>
    /// Generated code keeps its regions: generators write them, and nobody reads or edits that output.
    /// </summary>
    [Theory]
    [InlineData("Service.g.cs", "#region Generated\nclass A { }\n#endregion")]
    [InlineData("Service.cs", "// <auto-generated/>\n#region Generated\nclass A { }\n#endregion")]
    public async Task ARegionInGeneratedCodeIsNotReported(string path, string source)
        => Assert.Empty(await AnalyzerRun.DiagnosticsOf(new NoRegionsAnalyzer(), (path, source)));
