...
namespace Abblix.Oidc.Server.Mvc.SourceGenerators;
...
public class MvcModelGenerator : IIncrementalGenerator
{
	...
	private const string DiagnosticCategory = "Abblix.Oidc.Server.Mvc.SourceGenerators";
			...
			StubInfo stub, INamedTypeSymbol coreType, Compilation compilation, string declarativeNamespace)
	{
		...
		public GenerationResult Emit()
		{
			...
			_writer.AppendLine($"// Generated by Abblix.Oidc.Server.Mvc.SourceGenerators from {coreType.ToDisplayString()}.");
