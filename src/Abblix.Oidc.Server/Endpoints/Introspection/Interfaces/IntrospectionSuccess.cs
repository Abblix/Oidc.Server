...
/// <summary>
/// Server-side model of the introspection response defined by RFC 7662 section 2.2: a Boolean
...
/// IANA "OAuth Token Introspection Response" registry (RFC 7662 section 3.1).
/// </summary>
public record IntrospectionSuccess(bool Active, JsonObject? Claims, ClientInfo ClientInfo)
{
    ...
    /// "OAuth Token Introspection Response" registry (RFC 7662 section 3.1).
    /// </summary>
    public static class Parameters
    {
        /// <summary>The <c>active</c> response member (RFC 7662 section 2.2) reporting whether the token is
    ...
    /// revoked, unknown, or not allowed) and per section 2.2 is returned without disclosing why.
    /// </summary>
