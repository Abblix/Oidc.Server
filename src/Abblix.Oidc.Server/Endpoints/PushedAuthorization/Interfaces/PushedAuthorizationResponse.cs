...
/// <summary>
/// Successful response from the Pushed Authorization Request endpoint (RFC 9126 section 2.2):
...
{
    /// <summary>
    /// RFC 9126 section 2.2 <c>request_uri</c>: a one-time-use, server-generated reference to the
    ...
    /// <summary>
    /// RFC 9126 section 2.2 <c>expires_in</c>: lifetime of <see cref="RequestUri"/>; once it elapses
