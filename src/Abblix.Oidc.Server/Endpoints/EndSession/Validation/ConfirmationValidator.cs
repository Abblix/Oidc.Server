...
/// current OP session with the RP and/or currently logged in End-User". This validator surfaces
/// <see cref="ErrorCodes.ConfirmationRequired"/> until the host echoes back <c>confirmed=true</c>.
/// </summary>
...
public class ConfirmationValidator(
    ...
    ISubjectTypeConverter subjectTypeConverter) : IEndSessionContextValidator
{
    /// <inheritdoc />
