...
/// <summary>
/// Parameters of an OAuth 2.0 token revocation request (RFC 7009 section 2.1) sent to the
...
{
	/// <summary>
	/// Wire-level parameter names accepted at the OAuth 2.0 revocation endpoint (RFC 7009 section 2.1).
	/// </summary>
	...
	/// <summary>
	/// The <c>token</c> parameter (RFC 7009 section 2.1): the access token or refresh token string the client
	...
	/// <summary>
	/// The optional <c>token_type_hint</c> (RFC 7009 section 2.1) advising whether <see cref="Token"/> is an
