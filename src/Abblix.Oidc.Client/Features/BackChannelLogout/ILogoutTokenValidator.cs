...
/// <summary>
/// Validates the Logout Token a provider posts to this client to say a session has ended
/// (OpenID Connect Back-Channel Logout 1.0 section 2.6).
/// </summary>
/// <remarks>
/// The request carrying this token is unauthenticated and comes from a caller this client never spoke to
