...
namespace Abblix.Oidc.Server.MinimalApi.SourceGenerators;
...
public class MinimalApiModelGenerator : IIncrementalGenerator
{
    ...
    private const string DiagnosticCategory = "Abblix.Oidc.Server.MinimalApi.SourceGenerators";
    ...
    private sealed class ModelEmitter(StubInfo stub, INamedTypeSymbol coreType, KnownTypes known)
    {
        ...
        public GenerationResult Emit()
        {
            ...
            _writer.AppendLine($"// Generated by Abblix.Oidc.Server.MinimalApi.SourceGenerators from {coreType.ToDisplayString()}.");
